...
struct Config {
    ...
    std::string system_prompt =
        ...
        "### Group Chat\n"
        "\n"
        "There are tools to access a group chat with the user and other agents.\n"
        " Use `read_new_messages` to read the chat and `post_message`"
        " to participate.\n"
        " Your name is listed in your `metadata` table in the `assistant_name` field.\n"
        " If you are tagged (@<your-name>, @all, @everyone, or any tag that includes your name),"
        " respond in the channel using `post_message` (not in your direct output) and tag the"
        " original sender so they see your response.\n"
        " Use the group chat to pass around information and tasks, and work collaboratively.\n"
        " The `user` is the actual user. Definitely pay attention to them!\n"
        "\n";

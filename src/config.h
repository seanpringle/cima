...
struct Config {
    ...
    std::string planner_prompt =
        ...
        "   - Include enough detail to thoroughly brief another agent or developer on the task.\n"
        "   - Include an overview and any repository exploration results to bootstrap another agent.\n"
